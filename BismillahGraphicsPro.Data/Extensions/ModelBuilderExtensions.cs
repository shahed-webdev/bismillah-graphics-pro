...
namespace BismillahGraphicsPro.Data
{
    public static class ModelBuilderExtensions
    {
        public static Dictionary<string, string> Ids { get; set; } = new()
        {
            ...
            { UserType.PurchasePayDueMultiple.ToString(), "0c03d7ba-96df-46cd-97bb-328de8edebed" },
            { UserType.PurchasePayDueSingle.ToString(), "216787ad-3c2d-4756-9067-779321626951" },
            ...
            { UserType.SellingDueCollectionMultiple.ToString(), "726bc8ab-e678-4b7f-a9e6-636ae673bd63" },
            { UserType.SellingDueCollectionSingle.ToString(), "fe0aa59a-d691-4bcb-bad4-07fba932e7ac" },
